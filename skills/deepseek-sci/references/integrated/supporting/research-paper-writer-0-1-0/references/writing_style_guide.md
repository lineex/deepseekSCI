# Integrated supporting reference: research-paper-writer-0.1.0/references/writing_style_guide.md

> Embedded source: `embedded-source/research-paper-writer-0.1.0/references/writing_style_guide.md`
