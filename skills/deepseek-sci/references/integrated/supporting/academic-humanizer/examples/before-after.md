# Integrated supporting reference: academic-humanizer/examples/before-after.md

> Embedded source: `embedded-source/academic-humanizer/examples/before-after.md`
