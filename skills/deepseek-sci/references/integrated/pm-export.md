# Integrated capability: pm-export

> Embedded source: `embedded-source/pm-export/SKILL.md`
...
```bash
python "LOCAL_PATH" /tmp/pm_papers.json
```
...
- The Python script is at `LOCAL_PATH`
