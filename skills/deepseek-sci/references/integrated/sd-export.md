# Integrated capability: sd-export

> Embedded source: `embedded-source/sd-export/SKILL.md`
...
```bash
python {SKILL_DIR}/supporting/sd-export/scripts/push_to_zotero.py --ris-file "{RIS_FILE_PATH}"
```

Or push RIS content directly:

```bash
python {SKILL_DIR}/supporting/sd-export/scripts/push_to_zotero.py --ris-data "{RIS_CONTENT}"
```
...
```bash
python {SKILL_DIR}/supporting/sd-export/scripts/push_to_zotero.py --json "{JSON_FILE_PATH}"
```
...
```bash
python {SKILL_DIR}/supporting/sd-export/scripts/push_to_zotero.py --list
```
